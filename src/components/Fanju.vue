<template>
  <div id="Fanju">
    ...
    <div class="FanjuModel NeworldEcro">
      <div class="fan-ju-TvPlayRecommend csro">
        <table>
          <tr>
            <td>
              ...
              <div class="fan-ju-recommendCard">
                <img
                  class="TvPlayCardImg"
                  src="https://i0.hdslb.com/bfs/bangumi/image/fd46b5ee8708a29d08a392c8158396d0c29a9444.png@466w_260h.png"
                />
      ...
      <div class="fan-ju-model-Ranking csro">
        <table>
          <tr>
            <td>
              <div class="fan-ju-ranking-card"></div>
            </td>
            <td>
              <div class="fan-ju-ranking-card"></div>
            </td>
...
<style scoped>
.fan-ju-TvPlayRecommend {
    width: 100%;
    height: 170px;
}
.fan-ju-recommendCard {
  height: 150px;
  width: 340px;
